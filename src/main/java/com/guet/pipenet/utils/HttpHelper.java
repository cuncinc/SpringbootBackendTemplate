...
import com.guet.pipenet.exception.OApiException;
...
public class HttpHelper
{
     ...
     * @return
     */
    public static <T> T postByRest(String url, Class<T> returnClassName, Map<String, Object> inputParameter,
                                   String jsonBody)
    {
...
/*
	  public static String postWithKey(String appid,String keyPath, String url, WxRefundDto dto) throws OApiException {
	      ...
	      HttpRequest request = HttpRequest.post(url).withConnectionProvider(new SSLSocketHttpConnectionProvider
	      (sslContext));
    ...
    public static void main(String[] args)
    {
      ...
      /*  String jsonStr="{\"component_appid\":\"wxa797588149020de4\",
      \"component_verify_ticket\":\"ticket
      @@@6PEMgS7QZ2xzxJn9bdrOd6DB2xzm5I3liChyE8l4MdkruB10OzJl0FNsirqBXWoiB631xmw2fCHf84wCOSt9ZA\",
      \"component_appsecret\":\"a38dd974a9e6490dfbf5b21cd38f9996\"}\n";
        ...
        try
        {
            JsonObject jo = HttpHelper.httpPost("https://api.weixin.qq.com/cgi-bin/menu/get?access_token" +
                    "=7_LptTbnbGrlk8OrF3fSreUPozwvDXm_lE1LB-lqVXxD5VYW2XLcRCQ3G4FTwhe1LR670PkaItKHZm7TY4Ms" +
                    "-ECf8oDslqhyE3rUMo3GrqKLOFs8owbj9SSkF3Y6kYqd0GiYtzbgNLopPeP8AiDNYdABAXHS", null);
